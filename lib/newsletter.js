  ...
  const dealCards = deals.map((d) => `
    <tr><td style="padding:8px 0;">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="lob-dealcard" style="border:1px solid #eef2fb;border-radius:14px;background:#ffffff;">
        <tr>
          ${d.image ? `<td width="80" style="padding:14px 0 14px 14px;vertical-align:middle;"><img src="${d.image}" width="60" height="60" class="lob-logo" style="border-radius:10px;object-fit:contain;background:#ffffff;padding:7px;" alt=""></td>` : ""}
