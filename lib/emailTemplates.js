...
// Header als Bild (wird von Mail-Clients nie dark-invertiert → Logo immer lesbar).
    ...
    <tr>
      <td align="center" style="padding:32px 16px;">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" class="lob-card" style="max-width:600px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;border:1px solid #e6ecfb;">
          <tr>
            <td bgcolor="#122a4d" style="background-color:#122a4d;padding:0;font-size:0;line-height:0;">
              <img src="${BASE_ASSETS}/header-brand.png" width="600" alt="LOBBIUM – Smart Family Life" style="display:block;width:100%;max-width:600px;height:auto;border:0;">
            </td>
          </tr>
          <tr>
